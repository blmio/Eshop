...
config.Toolbars = [
	...
	["TBHandle", "Bold", "Italic", "UnderLine", "StrikeThrough", "SuperScript", "SubScript", "TBSep", "JustifyLeft", "JustifyCenter", "JustifyRight", "JustifyFull", "ParagraphAttr", "TBSep", "OrderedList", "UnOrderedList", "Indent", "Outdent", "TBSep", "ForeColor", "BackColor", "BgColor", "BackImage", "TBSep", "Fieldset", "HorizontalRule", "Marquee", "TBSep", "CreateLink", "Unlink", "Map", "Anchor"],
	["TBHandle", "Image", "Flash", "Media", "File", "GalleryMenu", "TBSep", "RemoteUpload", "LocalUpload", "ImportWord", "ImportExcel", "Capture", "TBSep", "TableMenu", "FormMenu", "TBSep", "QuickFormat", "TBSep", "Template", "Symbol", "Emot", "Art", "Excel", "PrintBreak", "NowDate", "NowTime", "TBSep", "Quote", "ShowBorders", "TBSep", "ZoomMenu", "Maximize", "About"]
];