...
public partial class admin_system_Help : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.PageAd1.TableName = "[e_helplist]";
        this.PageAd1.Fieldcolumn = "[Number],[title],[Stat],[CloseS],(select [title] from [e_helplist] as [We] where [We].[Number]=[e_helplist].[upid]) as [upidT],[upid]";
        this.PageAd1.Field = "[Number]";
        this.PageAd1.Order = "order by [Stat],[Number]";
        this.PageAd1.Url = "Help.aspx";
