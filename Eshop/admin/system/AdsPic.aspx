<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdsPic.aspx.cs" Inherits="admin_system_AdsPic" StylesheetTheme="Member" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
   ...
   <script type="text/javascript">
       derF["TitleName"] = "广告图片";
       derF["FrTable"] = "e_ads_flash";
       derF["Tableurl"] = "system/AdsPicModify.aspx";
       derF["winW"] = 400;
       derF["winH"] = 260;
       derF["Tn"] = 30;
       derF["SortT"] = "图片";
...
<div class="tabT">
  <div class="tabTR"></div>
  <div class="tablText"><img src="../../images/tab/tab_09.gif" width="16" height="13" /> <span class="tab4">广告图片管理</span></div>
